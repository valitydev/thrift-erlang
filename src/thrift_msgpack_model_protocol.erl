...
%% This protocol was part of https://github.com/valitydev/dominant.
%% This is why it follows produces instances of msgpack thrift model
%% and not msgpack-encoded binaries. One could adopt it to produce
%% the latter quite easily though.

-module(thrift_msgpack_model_protocol).
...
% NOTE
% Reflects the type of terms following this Thrift union:
% https://github.com/valitydev/damsel/blob/dac2cb5/proto/msgpack.thrift#L7-L16
-type 'Value'() ::
    % {'nl', 'Nil'()} |
    {'b', boolean()}
    | {'i', integer()}
