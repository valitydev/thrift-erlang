...
unnamed_union_test() ->
  ...
  ?assertMatch(
    ...
    thrift_protocol:write(
      Protocol,
      {{struct, union, [
        {1, optional, {struct, struct, {thrift1151_thrift, 'StructA'}}, 'a', undefined},
        {2, optional, {struct, struct, {thrift1151_thrift, 'StructB'}}, 'b', undefined},
        {3, optional, {struct, struct, {thrift1151_thrift, 'StructC'}}, 'c', undefined}
      ]}, S1}
    )
  ).
